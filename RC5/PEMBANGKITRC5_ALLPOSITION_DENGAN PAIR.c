/*
18 desember 2011
Pembangkit difference Algoritma RC5:
SELURUH POSISI PERUBAHAN SECARA OTOMATIS

Difference calculator with pair for RC5 algorithm
...
{ 
  ...
  for(xxx=0;xxx<64;xxx++)
  {
              ...
              for(x=0;x<jumlah_sample;x++)
              {
                  ...
                  fprintf(fdifference,"\n");
                  fprintf(fpair,"%08x%08x %08x%08x %08x%08x %08x%08x %08x%08x\n",
                  plainteks[0], plainteks[1],
                  plainteks1[0], plainteks1[1],
                  cipherteks[0], cipherteks[1],
                  cipherteks1[0], cipherteks1[1],
